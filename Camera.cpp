...
void Camera::toGPU(QGLShaderProgram *program)
{
    ...
    //vec4 obser(CalculObs(vrp, distancia, angX, angY)); //Todo preguntar és aquesta variable la del observador? NO
    vec4 obser = this->origin;

   GLuint glObservador = program->uniformLocation("viewer");
