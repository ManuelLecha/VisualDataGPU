...
private slots:
    ...
    void on_textureNormalFileEdit_returnPressed();
    void on_textureBackgroundFileEdit_returnPressed();

    void on_browseTextureBtn_pressed();
    void on_browseTextureBtn_Normal_pressed();
    void on_browseTextureBtn_Background_pressed();
